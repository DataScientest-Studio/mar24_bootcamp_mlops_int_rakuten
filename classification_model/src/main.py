...
from core.utils import upload_to_aws
import os
...
print(MODEL_BUCKET)
upload_to_aws('models/concatenate.keras', MODEL_BUCKET, 'concatenate.keras')

# Fusion Model
print("Training Fusion Model")
fusion_model = FusionModel(tokenizer)
fusion_model.preprocess_and_fit(X_train, y_train, X_val, y_val)
